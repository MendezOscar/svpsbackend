...
using System.Linq;
using svpsbackend.Entities;
using svpsbackend.Models;

namespace svpsbackend.Services
{
    ...
    {
        private svpsdbContext _context;

        public UserService(svpsdbContext context)
        {
            _context = context;
        }
        public UserService Authenticate(string username, string password)
        {
